...
def generate_launch_description():    
    ...
    state_filename = LaunchConfiguration('state_filename')
    ...
    state_filename_la = DeclareLaunchArgument(
            'state_filename',
            default_value=os.path.expanduser(
                '~/qcar_v2v_ws/mapping_output/'
                'qcar_real_20260802-014755.pbstream'),
            description='Absolute path to the frozen Cartographer state')
